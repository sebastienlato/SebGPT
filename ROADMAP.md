...
5. Implement and test deterministic extraction and splitting. **Read-only preflight and in-memory extraction contract clarifications approved; extraction implementation not authorized.**
