...
5. Implement and test deterministic extraction and splitting. **Read-only preflight implemented, verified, and accepted; extraction and processed-output implementation not authorized.**
