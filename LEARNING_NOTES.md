...
- **What remains unclear:** The conceptual architecture, detailed contract, and first implementation are accepted after independent review. The implementation demonstrates exact vocabulary binding, explicit parameters, internal positions, lookup shapes, deterministic initialization, and gradient accumulation. Its dedicated Gate 12 commit is authorized, while push remains separately gated and training context length remains undecided.
